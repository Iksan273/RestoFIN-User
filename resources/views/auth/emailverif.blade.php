                        ...
                        <div class="wrapper">
                            ...
                            <form id="emailRegistForm" action="{{ route('verif-reg') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" name="verification_code" class="form-control" placeholder="Masukkan Kode Verifikasi" required>
                                ...
                                <button type="button" class="btn_1 mt-2 mb-4" onclick="window.location.href='{{route('register')}}'">Batalkan</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            backToLogin.addEventListener('click', function() {
                window.location.href = '{{route('register')}}'; // Arahkan kembali ke halaman login
            });
        });
    </script>
    <!-- /script -->
